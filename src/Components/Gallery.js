...
const Gallery = () => {
  const galleryItems = [
    { link:"", title:"3D Space Themed Site", description: "Created with Three.js. One of the first sites I made. This allowed me to use my Unity eperience to create a solar system that moves on scroll. However it lacks responsiveness and polish.  ", photo: p1Image, className: 'galleryItem1 galleryItem' },
    { link:"https://bon317.github.io/ResponsiveCloneSite/", title:"Cloned Bird Website", description: "A project with the objective of making a clone of a random website found online. Reponsiveness and progressive enhancement methodology were the main goals in this project. This was done in vanilla js html and css and was my first responsive project. ", photo: p2Image, className: 'galleryItem2 galleryItem' },
    { link:"https://bon317.github.io/StylizedSearchBar/", title:"Stylized Search Bar", description: "A Search Bar that animates open and closed on click. A very simple project that I put in to represent all the minor projects done to hone my design skills, but dont quite qualify for a full prject. This was done with a focus on developing css and js skills.", photo: p3Image, className: 'galleryItem3 galleryItem' },
    { link:"https://bon317.github.io/WeatherApp/", title:"Weather App", description: "This project makes two api calls to retrieve data on the weather of a given city, and a photo of that city. This project was an introduction to asychonous programming with promises in javascript with http api requests. ", photo: p4Image, className: 'galleryItem4 galleryItem' },
    { link:"https://bon317.github.io/TaskTracker/", title:"Task Tracker App", description: "This was my first project with the react library. An introduction to component based programming using functional components. As well as introduction to JSX and other react paradyms.", photo: p5Image, className: 'galleryItem5 galleryItem' },
    { link:"https://bon317.github.io/NWSite", title:"Northwest Couseling Website", description: "This was a site created with the goal of recreating a website builder site in order to gain full customizability over it. A custom image carousel was added, images were cleaned up, and animation effects were added. This was done in vanilla js html and css.", photo: p6Image, className: 'galleryItem6 galleryItem' },
    { link:"", title:"React Login App", description: "Introduction to full stack development with React, Node.js and express, connected to an SQL database. Used Wamp servers to maintain the server. This was also a lesson in using class components instead of functional.", photo: p7Image, className: 'galleryItem7 galleryItem' }
  ];
