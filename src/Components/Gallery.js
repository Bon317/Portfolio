...
const Gallery = () => {
  const galleryItems = [
    { link:"", title:"3D Space Themed Site", description: "Created with Three.js. One of the first sites I made. This allowed me to use my Unity eperience to create a solar system that moves on scroll. However it lacks responsiveness and polish. It was a fun beginner project tailored to a specific screen size.", photo: p1Image, className: 'galleryItem1 galleryItem' },
